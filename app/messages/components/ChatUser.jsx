  ...
  return (
    <div
      ...
      className={`flex items-center gap-3 px-4 py-3 m-1 rounded-xl cursor-pointer 
        hover:bg-gray-200 dark:hover:bg-[rgb(30,50,50)] 
        ${isActive ? "bg-gray-200 dark:bg-[rgb(30,50,50)]" : ""}`}
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="w-[90%] truncate capitalize">{user?.username}</p>
