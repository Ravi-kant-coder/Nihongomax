      ...
      {showLeft && (
        <button
          ...
          className="hidden lg:flex absolute left-1 top-1/2 -translate-y-1/2 z-10
               h-20 w-6 bg-white/60 dark:bg-gray-700/80 text-black dark:text-white 
               rounded shadow-md hover:bg-white hover:scale-110 hover:shadow-lg 
               transition-all items-center justify-center cursor-pointer"
        >
          ◀
        </button>
      )}
